...
export class NavbarComponent implements OnInit {
  ...
  constructor(  private element: ElementRef, private router: Router, private _ser:PrincipalService, @Inject(DOCUMENT) private document: Document) {
    //document = this.d
  ...
  sidebarClose() {
      ...
      const mainPanel =  <HTMLElement>this.document.getElementsByClassName('main-panel')[0];
      if(typeof window !== 'undefined'){
        if (window.innerWidth < 991) {
          setTimeout(function(){
